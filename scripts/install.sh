...
[Unit]
Description=Phantom Server v6.0
...
manage_tunnel() {
    ...
    case $opt in
        ...
        4)
            echo ""
            journalctl -u phantom -n 50 --no-pager | grep -E "隧道|tunnel|Tunnel|cloudflare"
            ;;
    esac
}
